...
describe 'rvm::system' do
  ...
  context "with gnupg", :compile do
    ...
    it { should contain_gnupg_key('rvm_D39DC0E3_7D2BAF1CF37B13E2069D6956105BD0E739499BDB').with_key_id('D39DC0E3_7D2BAF1CF37B13E2069D6956105BD0E739499BDB').with_key_server('hkp://keys.gnupg.net') }
  end
